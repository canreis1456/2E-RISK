...
public class Lands implements java.io.Serializable{
    ...
    public Lands(GameController control) {
        ...
        lands[6] = new Land(6, "USA", new int[]{2, 4, 5, 14},"Grönland ");
        ...
        lands[14] = new Land(14, "USA", new int[]{6, 15, 16},"İzlanda ");
        lands[15] = new Land(15, "USA", new int[]{14, 16, 18, 20},"BüyükBritanya ");
